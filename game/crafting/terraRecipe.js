...
setup.terraRecipe = {
	...
	//生鱼片：可由 三文鱼、鲈鱼、金枪鱼、红鲷鱼、鳟鱼、偏口鱼、棱晶孔雀鱼、硫火崖回鱼 在 工作台 上制作得到
	"Sashimi_Salmon": {
		name: "Sashimi",
        cn_name: "生鱼片",
		...
		required_crafting_station: "Work_Bench",
		required_crafting_station_info: "<<icon \"furniture_item/Cooking_Pot.png\">>工作台",
	...
	//熟鱼：可由 三文鱼、鲈鱼、金枪鱼、红鲷鱼、鳟鱼、偏口鱼、棱晶孔雀鱼、硫火崖回鱼 在 烹饪锅 上制作得到
	"Cooked_Fish_Salmon": {
		name: "Cooked_Fish",
        cn_name: "熟鱼",
	...
	//海鲜大餐：可由 臭味鱼、装甲洞穴鱼、镜面鱼、双鳍鳕鱼、斑驳油鱼、霓虹脂鲤、混沌鱼、七彩矿鱼、公主鱼、沉沦帆鱼、海岸恶魔鱼 在 烹饪锅 上制作得到
