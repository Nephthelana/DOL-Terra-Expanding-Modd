...
- [主要内容](#主要内容)
  ...
  - [提示系统](#提示系统)
  - [物品制作系统](#物品制作系统)
  - [Dom罗宾拓展模组联动](#dom罗宾拓展模组联动内容)
  - [鹰宝宝模组联动](#鹰宝宝模组联动内容)
  - [日落伊甸园模组联动](#日落伊甸园模组联动内容)
  - [成就系统](#成就系统)
- [后续计划](#后续计划)
- [食用说明](#食用说明)
- [注意事项](#注意事项)
...
如果你决定游玩本模组，请务必阅读文末的[食用说明](#食用说明)和[注意事项](#注意事项)。
...
<details>
  ...
  ![血泪](https://github.com/user-attachments/assets/d0ba0c68-1f47-4e61-862c-80f05cb0aba9)
...
- 简单堆一下数字：9种鱼竿、35种鱼饵、14处钓鱼点、41种任务鱼、12种宝匣、28种普通渔获...
...
### 物品制作系统
> 融合！进化！(啊？)
- "材料"：部分物品会被标记为“材料”。你可以询问向导来了解这些材料可以用于制作的物品，以及制作对应物品所需要的制作站；
- 阁楼新增3种制作站：工作台、铁砧、烹饪锅；
- 制作物品：除了模组物品的合成外，还为原版的肥料新增了合成配方；
<details>
  <summary>点击查看图片</summary>

  ![制作](https://github.com/user-attachments/assets/e1042c9d-0d0f-4139-871e-7fb126d5eb04)
...
### [鹰宝宝模组](https://github.com/koooooiCarp/DOL-BabyHawk-Mod)联动内容
> 给鹰崽们改善一下伙食！
- 为鹰塔中的工具箱和烹饪锅增加了新用途：制作食物！
- 喂食鹰崽时，除了喂食潜伏者之外，还可以喂食生鱼片和熟鱼！
- 希望大家在鹰宝宝模组里，和鹰崽们玩得开心~\(≧▽≦)/~
<details>
  <summary>点击查看图片</summary>

  ![烹饪鱼类](https://github.com/user-attachments/assets/54db38c2-e5c8-42d8-9b57-49aeb017caeb)

</details>

### [日落伊甸园模组](https://github.com/LooopSpiner/In-The-Eden-After-Sunset)联动内容
> 和猎人在林中生活的点滴
- 伊甸小屋中摆放着闪亮亮的晶塔！
- 让伊甸看看你有多酷的鱼竿！
<details>
  ...
  ![晶塔](https://github.com/user-attachments/assets/d203287c-bf60-4b6c-8a5c-f5a70f881630)
  ![钓鱼](https://github.com/user-attachments/assets/79849162-5d36-4b4f-9826-ecea45f43f82)
...
以下内容仅供参考，更新内容以实际为准。
- [x] 新的钓鱼点：地下熔岩湖
- [ ] 新增位于神殿回廊，与悉尼有密切联系的神殿晶塔；
- [ ] 完善新增万圣节剧情；
- [ ] 新增图鉴相关的成就；
- [x] 为本体v0.5.3.x新增的“统计-钱”部分增加泰拉瑞亚拓展模组相关的内容（统计渔夫任务奖励、宝匣等金钱来源）
- [ ] 新增更多类似于`探鱼器`的信息饰品；
- [ ] 炼金草药种植系统；
- [ ] 无底水桶可用于应对街道上的骚扰；
- [ ] 完善海岛烹饪鱼类的内容；
...
3. 本模组部分功能依赖[简易框架模组](https://github.com/emicoto/DOLMods)（Simple Frameworks）生效，故在加载模组时，必须保证已经加载了简易框架模组，且**简易框架模组的加载顺序在泰拉瑞亚拓展模组之前**；
...
- 本模组最新版（v0.2.4）适配游戏本体0.5.3.7版本。
## 讨论交流
- 模组作者：苯环(Nephthelana)
- 贴吧名：脸木挤白
- QQ号：774295893(⌬ω⌬)(请在好友申请中注明来意)
- QQ交流群号：672887751
## 特别感谢
- 十分感谢 Vrelnir 创作了 Degrees of Lewdity 这个游戏！
- 十分感谢 [Lyoko-Jeremie](https://github.com/Lyoko-Jeremie) 编写了模组管理器(JML)，[Number_Sir](https://github.com/NumberSir) 制作了模组编写助手(MCH)！
...
- 感谢 [幸福论00(Eudemonism00)](https://github.com/Eudemonism00) 在内的多位大佬给予代码上的帮助与支持！
- 感谢 Dusty 提供的增加学校泳池作为钓鱼点的想法，博物馆处获得掘墓者铲子，血月初遇恐惧鹦鹉螺等等，无法一一列举的大量剧情文本！
- 感谢 酱油瓶j 提供的大量想法和模组测试反馈！
- 感谢 Ayuko 绘制的图片，包括地下永冻湖、地下熔岩湖的背景图等等！
- 感谢 雾小星 提供的回到鹰塔晶塔、获得皇家美味等等剧情的文本、想法与测试支持！
...
- [社交栏NPC小头像模组](https://github.com/Eudemonism00/DOL-NPC-Avatars-Mod) by [幸福论00(Eudemonism00)](https://github.com/Eudemonism00)
## 免责声明
